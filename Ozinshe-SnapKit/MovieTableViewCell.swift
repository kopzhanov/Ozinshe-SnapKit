...
class MovieTableViewCell: UITableViewCell {
    ...
    let subtitleLabel = {
        ...
        label.text = "2022 • Телехикая • Мультфильм"
    ...
    let playView = {
        let view = UIView()
        view.backgroundColor = UIColor(red: 0.97, green: 0.93, blue: 1.00, alpha: 1.00)
        ...
        label.textColor = UIColor(red: 0.59, green: 0.33, blue: 0.94, alpha: 1.00)
